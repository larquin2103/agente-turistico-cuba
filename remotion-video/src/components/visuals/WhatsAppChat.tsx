...
const conversations: Record<ChatContext, {
  ...
  dental_midnight: {
    ...
    messages: [
      { from: "user", text: "Hola, tengo un dolor de muela horrible 😖 ¿Tienen consulta de urgencia mañana?" },
      { from: "bot", text: "¡Hola! Lamento que estés con dolor. Sí, tenemos disponibilidad mañana:" },
      { from: "bot", text: "🕘 9:00 AM\n🕚 11:30 AM\n🕒 3:00 PM\n\nMientras tanto, evita alimentos muy fríos o calientes. ¿Te reservo alguna?" },
      { from: "user", text: "Las 9 AM por favor 🙏" },
      { from: "bot", text: "✓ Listo. Consulta confirmada mañana 9:00 AM con el Dr. Méndez. Te envío un recordatorio 1 hora antes." },
    ],
  },
  travel_airport: {
    header: "Agencia Camagüey Travel",
    subheader: "● En línea · 02:14 AM",
    messages: [
      { from: "user", text: "Acabo de llegar a Camagüey, mi vuelo aterrizó. ¿A qué hora puedo hacer check-in en el hotel?" },
      { from: "bot", text: "¡Bienvenido a Camagüey! Tu hotel (Gran Hotel) acepta check-in temprano desde las 10:00 AM. Como tu vuelo llegó a las 2 AM, puedes:" },
      { from: "bot", text: "🛏 Usar el lobby + desayuno cortesía (incluido)\n🚕 El traslado a Playa Santa Lucía te espera en la salida\n📞 Recepción del hotel disponible 24h" },
      { from: "user", text: "¡Perfecto, muchas gracias!" },
      { from: "bot", text: "Disfruta tu estancia 🌴 Cualquier cosa durante el viaje, aquí estoy 24/7." },
    ],
  },
  travel_sale: {
    header: "Agencia Camagüey Travel",
    ...
    messages: [
      { from: "user", text: "Hola, busco un paquete a Playa Santa Lucía para 4 personas en julio" },
      { from: "bot", text: "¡Excelente elección! Tengo 3 opciones disponibles:" },
      { from: "bot", text: "🏖 Brisas Santa Lucía · 7 noches · todo incluido\n🏛 Gran Hotel Camagüey · 5 noches · centro histórico\n🤿 Combinado playa + buceo · 7 noches\n\nTodos con traslados y desayunos. ¿Te envío los detalles de alguno?" },
      { from: "user", text: "El de Brisas Santa Lucía me interesa, ¿confirmamos?" },
      { from: "bot", text: "✓ Reserva pre-confirmada. Te envío el itinerario completo y los pasos para formalizarla." },
    ],
  },
};
